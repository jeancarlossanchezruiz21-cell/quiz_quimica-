...
Si necesitas crear las tablas nuevamente, copia `supabase-setup.sql` en el SQL Editor de Supabase y pulsa **Run**.

## Enlace público

https://jeancarlossanchezruiz21-cell.github.io/quiz_quimica-/
